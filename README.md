...
Есть некоторый [csv-файл](../Users/Соня/Desktop/dj-homeworks/dj-homeworks/databases/work_with_database/phones.csv), который выгружается с сайта-партнера. Этот сайт занимается продажей телефонов.
...
![Каталог с телефонами](../Users/Соня/Desktop/dj-homeworks/dj-homeworks/databases/work_with_database/res/catalog.png)
